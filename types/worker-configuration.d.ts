/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts` (hash: d9c7ea24040f41a9758f53c661bd7c17)
// Runtime types generated with workerd@1.20250712.0 2025-07-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EVENT: DurableObjectNamespace<import("../src/server/routes").Event>;
		GUEST: DurableObjectNamespace<import("../src/server/routes").Guest>;
		ASSETS: Fetcher;
	}
}
